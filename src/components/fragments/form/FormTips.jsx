...
export default function FormTips() {
  ...
  const tipsData = [
    { name: "MEMILIH BAHAN", img: "/assets/tips1.jpg", path: "/pilih-bahan" },
    { name: "KOMBINASI WARNA", img: "/assets/tips2.jpg", path: "/paduan-warna" },
    { name: "PENGGUNAAN AKSESORIS", img: "/assets/tips3.jpg", path: "/aksesoris" },
  ];
