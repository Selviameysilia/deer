...
export const KategoriSection = () => {
  ...
  const kategori = [
    { name: "Kaos", img: "/assets/kategori1.png", path: "/kaos" },
    { name: "Kemeja", img: "/assets/kategori2.png" },
    { name: "Jaket", img: "/assets/kategori3.png" },
    { name: "Hoodie", img: "/assets/kategori4.png" },
    { name: "Denim", img: "/assets/kategori5.png" },
    { name: "Cargo", img: "/assets/kategori6.png" },
    { name: "Chino", img: "/assets/kategori7.png" },
    { name: "Jas", img: "/assets/kategori8.png" },
    { name: "Parka", img: "/assets/kategori9.png" },
    { name: "Aksesoris", img: "/assets/kategori10.png" },
  ];
...
export const InspirasiGayaSection = () => {
  ...
  const inspirasiGaya = [
    { name: "Formal", img: "/assets/formal.jpg", path: "/fashion-style" },
    {
      name: "Semi Formal",
      img: "/assets/semi formal.jpg",
      path: "/fashion-style",
    },
    {
      name: "Sehari Hari",
      img: "/assets/sehari hari.jpg",
      path: "/fashion-style",
    },
    { name: "Casual", img: "/assets/casual.jpg", path: "/fashion-style" },
  ];
