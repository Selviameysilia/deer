  ...
  return (
    <section className="text-gray-800">
      ...
      <div className="relative w-full">
        <img
          src="/assets/banner memilih bahan.jpg"
          alt="Memilih Bahan"
