...
const FormKelolaPembayaran = () => {
  const [pembayaran, setPembayaran] = useState([
    { id: 1, nama: "Andi Pratama", tanggal: "01/02/24", status: "Dikonfirmasi", bukti: "/assets/tf bukti.jpeg" },
    { id: 2, nama: "Syahputra", tanggal: "18/05/24", status: "Belum dikonfirmasi", bukti: "/assets/tf bukti.jpeg" },
  ]);
